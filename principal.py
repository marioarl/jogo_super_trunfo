...
x = randint(0,13)
monte1.insert(x,6) #Insere a carta Super trunfo no monte1 na posicao de indice 7
...
for n in range(0,13):   
    ...
    while len(monte2) <=12: 
        ...
        if j not in monte2 and j not in monte1 and j !=22:
            monte2.append(j)
x = randint(0,13)
monte2.insert(x,22)#Insere a carta Super trunfo no monte2 na posicao de indice 10
...
while True:
    if len(monte1) > 0 or len(monte2) > 0:
        ...
        uteis.placar(monte1, monte2) #Modulo para o placar
